...
def main():
    ...
    parser.add_argument("--output", type=Path, required=True, help="Directory to save the mutated library")
    parser.add_argument("--seed", type=int, default=42, help="Random seed for deterministic renaming")
    parser.add_argument("--theme", choices=["gibberish", "fantasy"], default="gibberish", help="Naming theme")
    parser.add_argument("--internal-prefix", action="append", help="Prefix of internal modules (e.g. 'flask') to allow renaming import targets.")
